/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 99df0617fbd89f2b551e60887bb94667)
// Runtime types generated with workerd@1.20250823.0 2025-07-16 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		music_axlz: KVNamespace;
		SERVICE_URL: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SERVICE_URL">> {}
}
